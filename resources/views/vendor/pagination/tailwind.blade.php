@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-center mx-auto">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-center my-6">
            <div>
